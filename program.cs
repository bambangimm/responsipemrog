...
namespace  ResponsiPemrog2819
{
     Program kelas
    {
        static  void  Main ( string [] args )
        {
            Karyawan  k1  =  Karyawan baru  ( " 18112357 " , " bambang " , 3000000 );
            Tampil ( k1 );
            Karyawan  k2  =  Karyawan baru  ( " 18112234 " , " arif " , 2000000 );
            Tampil ( k2 );

            Konsol . WriteLine ( " \ n  gaji naik 10% \ n " );
            Tampil2 ( k1 );
            Tampil2 ( k2 );
